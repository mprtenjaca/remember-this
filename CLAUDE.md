...
> **PHASE A — still Expo Go (SDK 54), but the dev build is the next step.** `eas.json` and `npm run build:dev`
> are ready; nobody has installed one yet.
